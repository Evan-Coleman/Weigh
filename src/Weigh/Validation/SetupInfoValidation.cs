        ...
        public static ValidationResult HeightMajorValidation(string heightMajor)
        {
            ...
            if (Settings.Units)
            {
                ...
                return new ValidationResult(
                    Resources.HeightMajorImperialValidationErrorMessage);
            }
            ...
            if (isValid)
                return ValidationResult.Success;
            return new ValidationResult(
                Resources.HeightMajorMetricValidationErrorMessage);
        }
        ...
        public static ValidationResult WaistSizeValidation(string waistSize)
        {
            ...
            if (Settings.WaistSizeEnabled)
            {
                if (waistSize.Length < 1 || waistSize.Length > 5)
                    return new ValidationResult(Resources.WaistLengthValidationErrorMessage);
                if (WaistSize > 200 || WaistSize < 15)
                    return new ValidationResult(Resources.WaistValueValidationErrorMessage);
            }
