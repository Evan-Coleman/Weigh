...
namespace Weigh.Models
{
    public class SettingVals : BindableBase
    {
        ...
        public void SetBMICategory()
        {
            ...
            if (BMI < 18.5) BMICategory = Resources.UnderweightBMICategory;

            if (BMI >= 18.5 && BMI <= 24.9) BMICategory = Resources.NormalWeightBMICategory;

            if (BMI >= 25 && BMI <= 29.9) BMICategory = Resources.OverweightLabel;

            if (BMI >= 30) BMICategory = Resources.ObeseLabel;
        }
        ...
        public bool ValidateGoal()
        {
            ...
            if (DistanceToGoalWeight <= 0)
            {
                ...
                //UserDialogs.Instance.Alert(string.Format(Resources.GoalTooSoonPopup, GoalDate));
            }
